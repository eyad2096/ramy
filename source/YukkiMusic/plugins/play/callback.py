...
※ [انا بوت تشغيل الأغاني والفيديو  في المكالمه المرئية](https://t.me/isRamy) \n
※[لاظهار كيبورد الاعضاء اضغط](https://t.me/isRamy) /Angel \n
※ [في حال مواجهه اي مشكله انضم هنا](https://t.me/isRamy)\n [ᖴ᥆ᖇ Ramy. 🐰](https://t.me/M_i_X)
※ [استخدم الازرار لمعرفه الاوامر المستخدمه.](https://t.me/isRamy) """,
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton("الدعم والتواصل", url=f"https://t.me/M_i_X"),
                
InlineKeyboardButton("لتفعيل كيبورد الاعضاء", callback_data="Ramy"),
                ],
                [                   InlineKeyboardButton("طريقة التشغيل", callback_data="bcmds"),
                    InlineKeyboardButton("طريقة التفعيل", callback_data="dama"),
                ],
                [
                    InlineKeyboardButton(
                        "الگروب", url=f"https://t.me/+JRoMoGEYSHIyY2Yy"
                    ),
                    InlineKeyboardButton(
                        "القناة", url=f"https://t.me/isRamy"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "𝖥𝗈𝗋 Ramy . 💸", url="https://t.me/M_i_X"
                    )
                ],
            ]
        ),
...
async def english(_, query: CallbackQuery):
    await query.answer("home start")
    await query.edit_message_text(
        f" [※A Telegram Music Bot Based Mongodb](https://t.me/isRamy) \n ※[Add Me To Ur Chat For and Help and And Support Click On Buttons](https://t.me/M_i_X) \n ※[These Features AI Based](https://t.me/isRamy)",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
...
InlineKeyboardButton(" member keyboard ", callback_data="ww_2_2"),
                ...
                [                
                    ...
                    InlineKeyboardButton(" Donate", url=f"https://t.me/isRamy"),
                ],
                [
                    InlineKeyboardButton(
                        "Group", url=f"https://t.me/+JRoMoGEYSHIyY2Yy"
                    ),
                    InlineKeyboardButton(
                        "Channel", url=f"https://t.me/isRamy"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "𝖥𝗈𝗋 DaMa . 💸", url="https://t.me/M_i_X"
                    )
                ],
            ]
        ),
...
async def cbguides(_, query: CallbackQuery):
    ...
    await query.edit_message_text(
        f"""🐰 **※Welcome \n
※Show members keyboard Send /levi \n\n
※Show entertainment keyboard send /levi**
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🔙 Go Back", callback_data="english")]]
        ),
...
@Client.on_callback_query(filters.regex("dama"))
...
\n√ **في حال واجهت اي مشكلة اخري يمكنك التواصل مع افيونا من هن : @Mi_X **
\n __ Developer by [𝖥𝗈𝗋 Ramy . 💸](https://t.me/M_i_X)""",
        reply_markup=InlineKeyboardMarkup(
...
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""※ مرحبا بك \n ※ لتفعيل كيبورد الاعضاء ارسل /Angel \n ※ لتفعيل كيبورد التسليه ارسل /Angel""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("العودة", callback_data="bcmds")]]
        ),
    )
...
@Client.on_callback_query(filters.regex("M_i_X"))
async def acbadmin(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""<b> يمكنك التواصل معي \n عن طريق معرفي اول جروب التواصل بلاسفل..↑↓ \n\n [𝖥𝗈𝗋 Ramy . 💸](https://t.me/M_i_X)</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("القناة", url=f"https://t.me/isRamy"),
                    InlineKeyboardButton("الجروب", url=f"https://t.me/+JRoMoGEYSHIyY2Yy"),
                ],
                [
                    InlineKeyboardButton("البوت", url=f"https://t.me/zbgbot"),
                    InlineKeyboardButton("التواصل", url=f"https://t.me/M_i_X"),
                ],
                [InlineKeyboardButton("Ramy. 🐉", url=f"https://t.me/M_i_X")],
            ]
        ),
    )
