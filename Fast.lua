...
bot = Fx.Fastbots.set_config{api_id=1846213,api_hash='fec3debe458def91d6d333653c55caae',session_name=Fast,token=Token}
function var(value)
...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1314630552,5774423143,5905400733}
...
send(data.chat_id,data.id,"※ اهلا بك في صانع بوتات ميوزك سورس ANGEL \n※ مطور البوت @M_i_X","html",true, false, false, true, reply_markup)
return false 
end
---making user
