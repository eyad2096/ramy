    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "**عفوا الاتصال مغلق في كروبك**\n\nمن فضلك قم بتشغيل المحادثه الصوتيه اولا في مجموعتك. واذا كانت بلفعل مشغله قم بإنهاء المحدثه وابدأ تشغليها من جديد واذا تكررت المشكله قم بتحديث الروبوت , اكتب ( **ريستارت أو restart** ) دون استخدام اي علامات •"
                )
